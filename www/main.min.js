...
!function(){"use strict";function e(e){return e.withConfig(function(e){e.setResponseExtractor(function(e){return e.venue})})}function n(e){function n(e){return t.one(e).get()}var t=e.all("venues");return{get:n}}function t(e){function n(e,n,o){var r=[e,n],u=17,i={title:o};a.setView(r,u),t.marker(r,i).addTo(a)}var t=window.L,a=t.mapbox.map("map",e.map_type,e.map_options);return a.dragging.disable(),a.doubleClickZoom.disable(),a.scrollWheelZoom.disable(),{setLocation:n}}angular.module("venues").factory("VenuesRestangular",["Restangular",e]).factory("venuesFactory",["VenuesRestangular",n]).factory("mapFactory",["MAPBOX_CONFIG",t])}();