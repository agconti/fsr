...
!function(){"use strict";function t(t,r){t.state("list",{url:"/lists",resolve:{venue:["listsFactory",function(t){return t.get()}]},templateUrl:"./fsr/lists/index.html",controller:"ListController",controllerAs:"list"})}angular.module("lists",["ui.router","restangular"]).config(["$stateProvider","$urlRouterProvider",t])}();
...
!function(){"use strict";function t(t,n){var e=this;this.venue=t,this.get=function(){n.get().then(function(t){e.venue=t})},this.getImageUrl=function(){var t=e.venue.photo.prefix,n=[828,628].join("x"),i=e.venue.photo.suffix;return[t,n,i].join("")}}angular.module("lists").controller("ListController",["venue","listsFactory",t])}();

!function(){"use strict";function t(t){return t.withConfig(function(t){t.setResponseExtractor(function(t){return t.list.listItems.items})})}function n(t){return t.withConfig(function(t){t.setResponseExtractor(function(t){return t.lists.groups})})}function s(t,n){function s(){return f.getList().$object}function r(t){return t[Math.floor(Math.random()*t.length)]}function e(t){for(var n=t.length,s=0,e=[];n>s&&(e=r(t),!e.items.length);s++)t.slice(t.indexOf(e),1);return e}function i(t){var n=e(t),s=r(n.items);return a.one(s.id).get().then(r)}function u(){return f.getList().then(i)}var o="lists",a=t.all(o),l="users/self",c=l+"/"+o,f=n.all(c);return{getListsGroups:s,get:u}}angular.module("lists").factory("UserListsRestangular",["Restangular",n]).factory("ListsRestangular",["Restangular",t]).factory("listsFactory",["ListsRestangular","UserListsRestangular",s])}();