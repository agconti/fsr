...
!function(){"use strict";function o(o,t,e,n){var l=this;console.log(o),l.venue=o,n.setLocation(o.location.lat,o.location.lng),l.get=function(){e.get().then(function(o){l.venue=o})["finally"](function(){t.$broadcast("scroll.refreshComplete")})},l.getImageUrl=function(){var o=l.venue.bestPhoto.prefix,t=[828,628].join("x"),e=l.venue.bestPhoto.suffix;return[o,t,e].join("")}}angular.module("lists").controller("ListController",["venue","$scope","listsFactory","mapFactory",o])}();
