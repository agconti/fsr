...
!function(){"use strict";function t(t,r){t.state("list",{url:"/lists",templateUrl:"./fsr/lists/index.html",controller:"ListController",controllerAs:"list"})}angular.module("lists",["ui.router","restangular"]).config(["$stateProvider","$urlRouterProvider",t])}();
...
!function(){"use strict";function t(t){var n=this;t.get().then(function(t){n.venue=t})}angular.module("lists").controller("ListController",["listsFactory",t])}();
